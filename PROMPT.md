...
This app was bootstrapped with a single Claude Code prompt, preserved
here for reference. Re-running it would regenerate a functionally
equivalent app from scratch.
